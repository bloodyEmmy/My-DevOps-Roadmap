...
4. ***Overlay ([[Overlay Network]])***.
	Объединяет несколько хостов без доп конфигураций для обеспечения взаимодействия между контейнерами на разных хостах (Используется в [[Docker Swarm]] для связи между [[Узел в Swarm (Nodes)]]).
