...
- Изолировать контейнеры от внешнего мира (если не проброшены [[Порт|порты]] при помощи [[Раздел Compose "ports"]] или [[00.02. Docker Команды/Команда "run"|Команда "run"]]).
