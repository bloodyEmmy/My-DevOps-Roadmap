...
Следовательно, контейнер использует сетевой стек хоста, ***поэтому нет возможности сопоставить [[Порт|порты]]*** ([[Раздел Compose "ports"]] + [[00.02. Docker Команды/Команда "run"|Команда "run"]]).
