...
***
1. Выбор ***Root Bridge***.
	Каждый [[Коммутатор (switch)|коммутатор]] изначально корневой => Отправляют соседям свой Bridge ID (приоритет + [[MAC-адрес]]) => сравнение ID, у кого меньше, тот и корневой.
