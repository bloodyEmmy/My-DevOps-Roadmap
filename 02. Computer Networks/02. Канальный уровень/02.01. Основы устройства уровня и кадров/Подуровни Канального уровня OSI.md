...
***
***Если проще, то LLC:***
- Определяет, какой [[Протокол уровня|протокол]] [[Сетевой уровень|сетевого уровня]] получит данные.
...
- Использует [[Физический уровень|физический уровень]] для отправки битов.
