...
2. Повторно вызывает `open()` с флагом `O_CREAT` для создания файла назначения. То есть [[Ядро операционной системы|ядро ОС]] выделяет новый [[Индексный узел (inode)|inode]] для нового файла.
